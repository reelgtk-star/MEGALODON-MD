...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~u0JyEDZT#ypfaluUVR6EL1pykecq6n5J_QoGSCvNJtTvo43nJbeg",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || "*",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "𒁂⃝𝐏𝐀𝐏𝐈 ✞ 𝐓𝐎𝐗𝐈𝐂家 et Mme kara",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "𒁂⃝𝐏𝐀𝐏𝐈 ✞ 𝐓𝐎𝐗𝐈𝐂家",           // Owner's name
    
    DEV: process.env.DEV || "50941484997",                     // Developer's contact number
    ...
    STICKER_NAME: process.env.STICKER_NAME || "𒁂⃝𝐏𝐀𝐏𝐈 ✞ 𝐓𝐎𝐗𝐈𝐂家",     // Sticker pack name
